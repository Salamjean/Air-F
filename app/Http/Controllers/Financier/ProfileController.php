...
class ProfileController extends Controller
{
    ...
    public function edit()
    {
        ...
        return view('financier.profile.edit', compact('user'));
    }

    /**
     * Met à jour le profil du financier.
     */
    public function update(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'redirect' => route('financier.profile.edit')
            ]);

        } catch (\Exception $e) {
            Log::error('Erreur lors de la modification du profil financier: ' . $e->getMessage());
            return response()->json([
                'success' => false,

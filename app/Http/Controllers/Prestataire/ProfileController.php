...
class ProfileController extends Controller
{
    ...
    public function edit()
    {
        ...
        return view('prestataire.profile.edit', compact('user'));
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            // Pour un prestataire, le prénom peut être nul ou vide
            ...
            return response()->json([
                ...
                'redirect' => route('prestataire.profile.edit')
            ]);

        } catch (\Exception $e) {
            Log::error('Erreur lors de la modification du profil prestataire: ' . $e->getMessage());
            return response()->json([
                'success' => false,

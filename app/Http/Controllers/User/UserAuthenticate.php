    ...
    public function submitDefineAccess(Request $request)
    {
        ...
        try {
            ...
            if ($user) {
                ...
                if ($user) {
                    $existingcodehop = ResetCodePasswordUser::where('email', $user->email)->count();
        ...
        try {
            if (auth('user')->attempt($request->only('email', 'password'))) {
                ...
                if ($user->role === 'finance') {
                    return redirect()->route('financier.dashboard')->with('success', 'Bienvenue sur votre espace Financier.');
                }

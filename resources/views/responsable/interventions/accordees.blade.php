...
@section('content')
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-10 gap-6">
            <div>
                ...
                <p class="text-lg text-gray-600 mt-2">Liste des interventions ayant reçu un accord de votre part ou de
                    l'administration.</p>
            </div>

            <!-- Search Bar -->
            <div class="w-full md:w-auto relative">
                <form action="{{ route('responsable.interventions.accordees') }}" method="GET" class="relative group">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200 group">
                                ...
                                <td class="px-6 py-4">
                                    @if($intervention->responsable)
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-xs font-bold">
    ...
    <script>
        function openFinanceModal(interventionId) {
            ...
            form.action = `/responsable/interventions/${interventionId}/assign-finance`;

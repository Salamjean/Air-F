...
@section('content')
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-10 gap-6">
            <div>
                <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight">Devis Reçus</h1>
                <p class="text-lg text-gray-600 mt-2">Validez les propositions financières des prestataires pour les
                    interventions traitées.</p>
            </div>

            <!-- Search Bar -->
            <div class="w-full md:w-auto relative">
                <form action="{{ route('responsable.interventions.devis') }}" method="GET" class="relative group">
                ...
                <table class="w-full whitespace-nowrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-6 py-4">Montant Estimé</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200 group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <div
                                            class="w-6 h-6 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600 text-xs">
                                ...
                                <td class="px-6 py-4">
                                    <span class="text-sm font-bold text-gray-900">
                                        {{ number_format($intervention->montant_estimatif, 0, ',', ' ') }} FCFA
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <span
                                        ...
                                        <i class="fas fa-file-invoice-dollar text-yellow-500"></i> Devis Reçu
                                    </span>
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900">Aucun devis en attente</h3>
                                        <p class="text-gray-500 mt-1 max-w-sm text-sm">Les devis soumis par les prestataires
                                            apparaîtront ici pour validation.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse

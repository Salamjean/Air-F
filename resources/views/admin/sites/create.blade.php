...
@section('content')
    <div class="container mx-auto max-w-2xl">
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mt-2">Ajouter un nouveau Site</h2>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <form action="{{ route('admin.sites.store') }}" method="POST">
                ...
                <div class="bg-gray-50 px-8 py-6 border-t border-gray-100 flex justify-end">
                    <button type="submit"
                        class="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-xl font-bold transition-all shadow-md focus:ring-4 focus:ring-red-100">
                        Enregistrer le Site
                    </button>
                </div>
            </form>

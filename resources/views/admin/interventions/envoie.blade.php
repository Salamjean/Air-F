    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-10 gap-6">
            <div>
                ...
                <p class="text-lg text-gray-600 mt-2">Suivez les interventions qui ont été transmises pour traitement.</p>
            </div>

            <!-- Search Bar -->
            <div class="w-full md:w-auto relative">
                <form action="{{ route('admin.interventions.envoie') }}" method="GET" class="relative group">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200 group">
                                ...
                                <td class="px-6 py-4">
                                    @if($intervention->personnel)
                                        <div class="flex items-center gap-2 cursor-pointer hover:bg-blue-50 p-1.5 rounded-lg transition-colors group/personnel"
                                            ...
                                            <span
                                                class="text-sm text-gray-700 group-hover/personnel:text-blue-700 font-medium dotted-underline">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900">Aucune intervention envoyée</h3>
                                        <p class="text-gray-500 mt-1 max-w-sm text-sm">Les interventions envoyées apparaîtront
                                            ici.</p>
                                    </div>
                                </td>
                            </tr>

...
@section('content')
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-10 gap-6">
            <div>
                <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight">Interventions Traitées</h1>
                <p class="text-lg text-gray-600 mt-2">Historique des interventions traitées et finalisées.</p>
            </div>

            <!-- Search Bar -->
            <div class="w-full md:w-auto relative">
                <form action="{{ route('admin.interventions.traitees') }}" method="GET" class="relative group">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200 group">
                                ...
                                <td class="px-6 py-4">
                                    @if($intervention->personnel)
                                        <div class="flex items-center gap-2 cursor-pointer hover:bg-purple-50 p-1.5 rounded-lg transition-colors group/personnel"
                                            ...
                                            <span
                                                class="text-sm text-gray-700 group-hover/personnel:text-purple-700 font-medium dotted-underline">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        ...
                                        <i class="fas fa-check-double text-purple-500"></i> Traitée
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <!-- <form action="{{ route('admin.interventions.envoyer', $intervention->id) }}" method="POST"
                                        ...
                                        onsubmit="return confirm('Êtes-vous sûr de vouloir marquer cette intervention comme envoyée ?');">
                                        @csrf
                                        <button type="submit"
                                            class="inline-flex items-center justify-center px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-lg transition-colors text-xs font-semibold border border-blue-200"
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900">Aucune intervention traitée</h3>
                                        <p class="text-gray-500 mt-1 max-w-sm text-sm">Les interventions traitées apparaîtront
                                            ici.</p>
                                    </div>
                                </td>
                            </tr>

            ...
            <div class="p-8">
                <form id="profileForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Ces informations sont visibles sur votre compte.</p>
                            </div>
                        </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}"
                                       readonly class="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-red-100 focus:border-red-500 transition-all outline-none text-gray-700 placeholder-gray-400">
                                </div>
                            </div>
                            ...
                            <div class="relative md:col-span-2">
                                ...
                                <div class="flex items-center gap-6">
                                    <div class="w-24 h-24 flex-shrink-0 relative group">
                                        <img id="previewImage"
                                            src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : 'https://ui-avatars.com/api/?name=' . $user->name . '+' . $user->prenom . '&background=EBF4FF&color=EF4444' }}"
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm text-gray-600">Changez votre photo de profil. Formats acceptés :
                                            PNG, JPG, GIF (max. 2MB).</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-8 pt-8 border-t border-gray-100">
                        <div class="flex items-center mb-6">
                            <div class="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-500 mr-4 border border-blue-100">
                                <i class="fas fa-lock"></i>
                            </div>
                            <div>
                                <h3 class="text-lg font-bold text-gray-800">Sécurité</h3>
                                <p class="text-xs text-gray-500">Laissez vide si vous ne souhaitez pas changer votre mot de passe.</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="relative">
                                <label for="password" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Nouveau mot de passe</label>
                                <div class="relative">
                            ...
                            <div class="relative">
                                <label for="password_confirmation" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Confirmer le mot de passe</label>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
        ...
        function confirmUpdate() {
            Swal.fire({
                ...
                preConfirm: (password) => {
                    ...
                    return fetch('{{ route("admin.profile.update") }}', {
                        method: 'POST',
                        body: formData,
                        headers: {

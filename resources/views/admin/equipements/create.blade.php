                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="longueur" class="block text-sm font-medium text-gray-700 mb-2">Longueur</label>
                                    <input type="text" name="longueur" id="longueur" value="{{ old('longueur') }}"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                                        placeholder="Ex: 10m">
                                </div>
                                <div>
                                    <label for="type" class="block text-sm font-medium text-gray-700 mb-2">Type (Optionnel)</label>
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="stock_quantity"
                                        class="block text-sm font-medium text-gray-700 mb-2">Quantité initiale</label>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="unit" id="unit" value="{{ old('unit', 'pièce') }}" required
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                            ...
                            <div>
                                ...
                                <input type="number" name="stock_min_alert" id="stock_min_alert"
                                    value="{{ old('stock_min_alert', 5) }}" min="0" required
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all">
                                <p class="text-[10px] text-gray-500 mt-1 italic">Vous serez alerté quand le stock sera
                                    inférieur ou égal à ce nombre.</p>
                            </div>

    ...
    <div class="mx-auto" style="width: 80%;">
        ...
        <div class="mb-6 flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Gérez vos informations de prestataire et votre sécurité.</p>
            </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Mettez à jour vos coordonnées professionnelles.</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <!-- Prénom (Optionnel pour prestataire) -->
                            <!-- <div class="relative">
                                <label for="prenom"
                            ...
                            <div class="relative md:col-span-2">
                                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Logo
                                    ou Photo de profil</label>
                                <div class="flex items-center gap-6">
                                    <div class="w-24 h-24 flex-shrink-0 relative group">
                                        <img id="previewImage"
                                            src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : 'https://ui-avatars.com/api/?name=' . $user->name . '&background=FEF2F2&color=EF4444' }}"
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm text-gray-600">Mettez à jour votre image de profil. Formats
                                            acceptés : PNG, JPG, GIF (max. 2MB).</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-8 pt-8 border-t border-gray-100">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Laissez vide si vous ne souhaitez pas changer votre mot de
                                    passe.</p>
                            </div>
                        </div>
        ...
        function confirmUpdate() {
            Swal.fire({
                ...
                preConfirm: (password) => {
                    ...
                    return fetch('{{ route("prestataire.profile.update") }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
